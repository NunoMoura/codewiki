...
import {createCustomCodeCheckExecutors} from "./packs/code-executor.ts";
import type {CustomCodeCapabilitySnapshot} from "./packs/code-templates.ts";
import type {ProtectedCustomCheckConfigSnapshot} from "./packs/configuration.ts";
import {
	assertProjectCheckPackSnapshot,
	type ProjectCheckPackSnapshot,
} from "./packs/project-config-store.ts";
import {
...
} from "./packs/resource-guards.ts";
import {projectVerificationState} from "../work-state/checks.ts";
import {
