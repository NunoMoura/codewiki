...
> = Object.freeze({
	...
	"planning.epoch_bound": definition([
		...
		"require_atomic_batch",
		["change_participates_in_epoch", "epoch_contains_work_item"],
		"latest_valid",
	]),
	"work_item_claim.acquired": definition([
		"work_item_claim.acquired",
		"work_item_claim.manage",
		TAIL,
		"Work Item is on fresh safe frontier and has no active Work Item Claim",
		"reject",
		["worker_claims_work_item"],
		"explicit",
	]),
	"work_item_claim.released": definition([
		"work_item_claim.released",
		"work_item_claim.manage",
		TAIL,
		"referenced Work Item Claim is active",
		"reject",
		["work_item_claim_released_by"],
		"never",
	]),
	"work_item_claim.takeover_recorded": definition([
		"work_item_claim.takeover_recorded",
		"work_item_claim.manage",
		TAIL,
		"prior Work Item Claim is active and authority is authenticated",
		"reject",
	...
	"assignment.dispatched": definition([
		...
		"assignment.manage",
		TAIL,
		"referenced Work Item Claim is active and exact",
		"reject",
	...
	"worker.report_recorded": definition([
		...
		"assignment.manage",
		TAIL,
		"Assignment and Work Item Claim bindings are exact",
		"retain_contradiction",
