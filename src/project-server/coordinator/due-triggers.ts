...
import type { ProjectServerHeartbeatRequest } from "./types.ts";

export interface ProjectServerDueTriggerHeartbeatPlan {
	generatedAt?: string;
	heartbeats: ProjectServerHeartbeatRequest[];
	skipped: ProjectServerDueTriggerSkip[];
}

export interface ProjectServerDueTriggerSkip {
	triggerId: string;
	traceId: string;
	reason: string;
	refs: string[];
...
export function planDueTriggerHeartbeats(
	view: TriggersView,
): ProjectServerDueTriggerHeartbeatPlan {
	const heartbeats: ProjectServerHeartbeatRequest[] = [];
	const skipped: ProjectServerDueTriggerSkip[] = [];
...
function dueTriggerHeartbeat(
	trigger: TriggerView,
): ProjectServerHeartbeatRequest | undefined {
