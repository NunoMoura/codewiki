...
import {
	buildProjectServerBoard,
	type ProjectServerBoard,
	type ProjectServerBoardRunPreview,
...
export interface WikiStateSnapshot {
	...
	runtimeBoard: ProjectServerBoard;
...
export function buildWikiState(input: WikiStateInput): WikiStateSnapshot {
	...
	const runtimeBoard = buildProjectServerBoard({
		generatedAt: input.generatedAt,
		traceBoard,
		workQueue,
		triggers,
