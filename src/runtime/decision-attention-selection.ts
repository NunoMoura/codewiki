...
export interface DecisionStartRuntimeOptions<TResult = unknown> {
...
export interface DecisionStartRuntime {
...
export function createDecisionStartRuntime<TResult = unknown>(
	options: DecisionStartRuntimeOptions<TResult>,
): DecisionStartRuntime {
...
function startExistingAttempt<TResult>(input: {
	readonly options: DecisionStartRuntimeOptions<TResult>;
