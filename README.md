...
Deployment/release, abrupt-death process observation, dashboard-service consolidation, trusted worker-image distribution, and external real-container/provider-auth proof remain later control-plane slices.
