...
- [ ] Add CodeWiki-owned bounded CycloneDX/SPDX, Playwright/axe, Pact/OpenAPI, and authenticated provider-check Evidence adapters with exact context identity, sanitation, authority ceilings, and no verdict authority.
...
Current checklist inventory after the bounded LCOV/Cobertura adapter cut: **73 complete, 49 remaining**.
