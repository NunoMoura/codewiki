...
Evidence schema `1.3.0` clean-cuts approval receipts to exact Check/version/purpose scoping and adds bounded security residual-risk bindings over prior Candidate approval, two independent assessment Evidence ids, exact high/critical risk, rationale digest, and optional finding digests. Generic Candidate approval cannot satisfy residual-risk authority, and qualified risk acceptance requires a separately authenticated identity.
...
Current checklist inventory after adding independent residual-risk Evidence and authority: **83 complete, 44 remaining**.
