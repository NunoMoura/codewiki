...
- [ ] Add CodeWiki-owned bounded CycloneDX/SPDX, Playwright/axe, and Pact/OpenAPI Evidence adapters with exact context identity, sanitation, authority ceilings, and no verdict authority.
...
Current checklist inventory after the authenticated provider-check receipt adapter cut: **74 complete, 49 remaining**.
