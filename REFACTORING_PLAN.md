...
- [ ] Add CodeWiki-owned bounded LCOV/Cobertura, CycloneDX/SPDX, Playwright/axe, Pact/OpenAPI, and authenticated provider-check Evidence adapters with exact context identity, sanitation, authority ceilings, and no verdict authority.
