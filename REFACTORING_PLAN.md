...
- [ ] Complete accepted protected-branch Git mutation and required policy-change review orchestration around the guarded command receipt; the working-tree adapter prepares and verifies the next config but cannot grant protected acceptance.
