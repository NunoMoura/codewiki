...
- [ ] Replace production Decision ref-count evidence sufficiency with external typed research collection, isolated Pi SDK claim-support transport, native Candidate/policy/report persistence, and canonical trace integration.
