...
- [ ] Expose one bounded user/agent triage query contract; no opaque overall score, mutable priority, arbitrary query DSL, or canonical triage store. Defer Backlog list/detail rendering to the final Dashboard phase.
