...
Agents consume bounded snapshot-bound context and produce exactly scoped Candidates, Assessments, research, or worker reports through Runtime-selected ports. They do not select Changes, alter canonical history, weaken policy, grant authority, or perform guarded effects.
