...
Durable WorkState event delivery, external real-model/auth proof for autonomous sessions, implementation-worker scheduling, dashboard-service consolidation, and generation-aware draining of active jobs remain open. One-shot host callers remain implementation drift rather than project-wide ownership.
