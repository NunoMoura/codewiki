...
Durable WorkState event delivery, Pi/dashboard migration, implementation-worker scheduling, and generation-aware draining remain open. Until those land, process-local Pi routing and one-shot host callers remain implementation drift rather than project-wide ownership.
