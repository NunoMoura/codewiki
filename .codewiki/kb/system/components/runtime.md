...
External real-model/auth proof for autonomous sessions, orphan packet/worktree cleanup across remaining crash windows, container workers, integration scheduling, full dashboard-service consolidation, abrupt-death cleanup, and cancellation-aware draining of active semantic SDK jobs remain open. One-shot host callers remain implementation drift rather than project-wide ownership.
