...
Evidence Records bind exact observations to Candidate, producer, tool, configuration, source, freshness, and authority. Authority remains `asserted`, `observed`, `verified`, or `approved`; sharing a record transfers neither applicability nor acceptance.
