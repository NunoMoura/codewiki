...
4. A released blocker wakes waiters with the claim id, planning refs, path scopes, and reason.
5. The woken worker or implementation iteration must fold current trace state and re-check claims before writing.
