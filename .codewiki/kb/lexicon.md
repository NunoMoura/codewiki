...
| Agent Supervisor | CodeWiki Backend component that submits immutable Run Specifications, starts and stops Agent Runners, records custody-scoped receipts, and owns no project meaning or lifecycle authority. | [Backend Execution](system/components/execution.md) |
...
| CodeWiki Backend | Standalone durable product service containing Server, per-project Runtimes, semantic owners, Agent Supervisor, Agent and Check Runners, and Workbench management. | [Package](system/components/package.md) |
