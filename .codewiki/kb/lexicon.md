...
| Assessment | Bounded model evaluation output from which Runtime derives one Check Result. | [Verification](system/components/verification.md) |
...
| Check Result | Immutable result of one resolved Check against one exact Candidate. | [Verification](system/components/verification.md) |
...
| Code Check | Trusted deterministic Check implementation. | [Verification](system/components/verification.md) |
| CodeWiki OS | Versioned guidance shared by CodeWiki-managed harness sessions. | [Harnesses](system/components/harnesses.md) |
| Custom Check | Repository-bound declarative Check derived from accepted User Standards. | [Verification](system/components/verification.md) |
| Decision | Loop that evaluates accepted intent and desired-Knowledge impact. | [Decision](system/components/decision.md) |
| Default Check | CodeWiki-provided Check from its closed versioned catalog. | [Verification](system/components/verification.md) |
...
| Model Check | Independently evaluated semantic Check with supported, unsupported, or uncertain Assessment. | [Verification](system/components/verification.md) |
...
| Verification | Shared Evidence, Check, Result, Exit Report, and policy machinery for all three Loops. | [Verification](system/components/verification.md) |
