...
description: Run the CodeWiki implementation loop. Use when exited planning work or a direct implementation decision row must become source/docs/tests changes with checks, acceptance evidence, content proof, and a durable implementation iteration.
---

# CodeWiki Implement

Use this skill when executing a planning work unit or direct implementation decision row in source, tests, or KB docs.
...
1. Read planning work refs or direct decision refs, acceptance criteria, source-map ownership, and candidate files.
