...
Stop when intent is unclear, approval is missing, destructive/public action lacks explicit approval, or the requested change contradicts current truth without user direction.
