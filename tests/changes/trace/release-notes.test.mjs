...
} from "../../../src/changes/trace/release-notes.ts";
import {
	createTraceHead,
...
function releaseRecords() {
	...
	const implementation = {
		...
		refs: [
			...
			"src/changes/trace/release-notes.ts",
			"tests/changes/trace/release-notes.test.mjs",
			"sha256:release",
		],
				...
				changes: [
					{
						...
						workUnitId: "WU-001",
						codePaths: ["src/changes/trace/release-notes.ts"],
						testPaths: ["tests/changes/trace/release-notes.test.mjs"],
						checkResults: [
							{
								command: "npm test",
								status: "pass",
								outputRef: "tests/changes/trace/release-notes.test.mjs",
						...
						acceptanceEvidenceItems: [
							{
								...
								evidenceRefs: ["tests/changes/trace/release-notes.test.mjs"],
							},
						],
