...
import { runWikiArchive } from "../../../src/project-server/commands/archive.ts";
...
async function archiveRecords(traceId = "TRACE-wiki-archive") {
			...
			workUnitInputs: [
				{
					...
					verification: ["tests/project-server/commands/archive.test.mjs"],
				},
			],
		}),
	};
	...
	const implementation = runImplementationIteration({
		...
		existingPaths: [
			...
			"tests/project-server/commands/archive.test.mjs",
		],
		changeInputs: [
			{
				id: "CHG-archive",
				...
				testPaths: ["tests/project-server/commands/archive.test.mjs"],
				checks: [
					"node --experimental-strip-types --test tests/project-server/commands/archive.test.mjs",
				],
				checkResults: [
					{
						command:
							"node --experimental-strip-types --test tests/project-server/commands/archive.test.mjs",
						status: "pass",
						outputRef: "tests/project-server/commands/archive.test.mjs",
					},
				],
				...
				acceptanceEvidenceItems: [
					{
						...
						evidenceRefs: ["tests/project-server/commands/archive.test.mjs"],
					},
				],
