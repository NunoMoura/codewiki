...
async function installPackage(root) {
	...
	return {
		...
		executeProjectServerWorktreeCommands: worktrees.executeProjectServerWorktreeCommands,
...
async function runWorktreeFailure(installed, root, step, reason) {
	await assert.rejects(
		installed.executeProjectServerWorktreeCommands(worktreePlan(root, reason), {
			steps: [step],
			dryRun: false,
			runner() {
