...
import { createProjectServerApi } from "../../../src/project-server/api.ts";

test("Project Server gateway exposes bounded grouped operations", async () => {
	const calls = [];
	const context = {
	...
	const gateway = createProjectServerApi(client);
...
test("App Server registers as observer of shared Project Server", async () => {
