...
import {buildTriggersView} from "../../../src/project-server/queries/triggers.ts";
import {buildQualityView} from "../../../src/work-state/quality.ts";
import {buildResumeView} from "../../../src/project-server/queries/resume.ts";
import {buildStatusView} from "../../../src/project-server/queries/status.ts";
import {buildTraceBoardView} from "../../../src/work-state/trace-goals.ts";
import {buildTraceQueueView} from "../../../src/project-server/queries/trace-queue.ts";
	...
	const workUnitInputs = configuredWorkUnitInputs || [
		{
			...
			verification: ["tests/project-server/queries/state-projections.test.mjs"],
				...
				changeInputs: [
					{
						...
						testPaths: ["tests/project-server/queries/state-projections.test.mjs"],
						checkResults: [{ command: "npm test", status: "pass" }],
						acceptanceEvidenceItems: [
							{
								criterionId: "AC-001",
								summary: "Queue projection test passed.",
								evidenceRefs: ["tests/project-server/queries/state-projections.test.mjs"],
							},
						],
		...
		changeInputs: [
			{
				id: "IC-run",
				planningRefs: [planningEvent.id],
				codePaths: ["src/project-server/queries/triggers.ts"],
				testPaths: ["tests/project-server/queries/state-projections.test.mjs"],
				checkResults: [{ command: "npm test", status: "pass" }],
				acceptanceEvidenceItems: [
					{
