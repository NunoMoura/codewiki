...
} from "../../../src/project-server/effects/research-collection.ts";
import {
...
describe("Decision research collection", () => {
	it("binds one trusted collection receipt and materializes Project Server-owned citation Evidence", async () => {
		const setup = fixture();
		let request;
