export function implementationQualityFields(overrides = {}) {
	return {
		implementationAssessment: {
			...
			maintainability: "Change is maintainable and localized to the planned scope.",
			...
			uncertaintyResolution: "No unresolved implementation, planning, decision, or user-authority uncertainty remains.",
