...
assert.equal(existsSync(join(packageRoot, "dist", "runtime", "lifecycle", "decision.js")), false);
...
assert.equal(existsSync(join(packageRoot, "dist", "runtime", "effects", "gate-operations.js")), true);
assert.equal(existsSync(join(packageRoot, "dist", "runtime", "effects", "decision-operations.js")), false);
assert.equal(existsSync(join(packageRoot, "dist", "runtime", "lifecycle", "decision.js")), false);
assert.equal(existsSync(join(packageRoot, "dist", "runtime", "lifecycle", "gates.js")), true);
...
assert.equal(existsSync(join(packageRoot, "dist", "server", "sessions", "contracts.js")), true);
assert.equal(existsSync(join(packageRoot, "dist", "server", "sessions", "contracts.d.ts")), true);
assert.equal(existsSync(join(packageRoot, "dist", "server", "sessions", "state.js")), true);
assert.equal(existsSync(join(packageRoot, "dist", "server", "sessions", "state.d.ts")), true);
assert.doesNotMatch(
