...
import { runCommonFastFeedback } from "../../../src/runtime/review/index.ts";
...
describe("implementation common fast feedback", () => {
	...
	it("passes clean scoped code-bearing edits", () => {
		const result = runCommonFastFeedback({
			changedPaths: ["src/runtime/review/fast-feedback.ts"],
			pathScopes: ["src/runtime/review/"],
			contentByPath: {
				"src/runtime/review/fast-feedback.ts": "export const ok = true;",
			},
		});
