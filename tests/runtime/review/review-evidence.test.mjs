...
} from "../../../src/runtime/review/index.ts";
...
describe("implementation review evidence protocol", () => {
	it("classifies artifacts without assuming TypeScript", () => {
		const examples = new Map([
			...
			[
				"tests/runtime/review/review-evidence.test.mjs",
	...
	it("normalizes common and language-specific evidence into one report", () => {
		const report = createImplementationEvidenceReport({
			...
			changedPaths: ["src/runtime/review/evidence-report.ts"],
			checks: [
				{
					command: "npm run typecheck",
					status: "pass",
					outputRef: "tests/runtime/review/review-evidence.test.mjs",
				},
			],
			diagnostics: [
				{
					path: "src/runtime/review/evidence-report.ts",
					severity: "error",
					message: "Example blocking diagnostic.",
					sourceId: "tsjs.tsc",
					ruleId: "TS0000",
					evidenceRefs: ["src/runtime/review/evidence-report.ts"],
				},
			],
			symbols: [
				{
			...
			dependencyEdges: [
				{
					from: "src/runtime/review/evidence-report.ts",
					to: "src/runtime/review/artifacts.ts",
					kind: "import",
				},
			],
			evidenceLinks: [
				{
					...
					criterionId: "AC-001",
					evidenceRefs: ["tests/runtime/review/review-evidence.test.mjs"],
				},
			],
		});
